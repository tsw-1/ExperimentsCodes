...
with open('/home/E22301339/depressionDetection-eRisk2018/processedData/data_BOSE.json', 'r') as f:
    data = json.load(f)

# with open('/home/E22301339/depressionDetection-eRisk2018/processedData/average_features4.json', 'r') as f:
...
# 使用t-SNE进行降维
tsne = TSNE(n_components=2, perplexity=50, n_iter=30 0, random_state=0, init="random")
...
# 显示图像
plt.show()
plt.savefig('tsne_plot2018_BOSE.png')  # 保存图像到文件