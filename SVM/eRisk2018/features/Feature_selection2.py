...
if __name__ == '__main__':
    ...
    X_train, y_train, X_test = ngrams(train, test, labels, ntrain, 1, 2, 300, donorm = True, verbose = verbose) #min_ngram, max_ngram, size of final vector
    X_train2, y_train, X_test2 = ngrams(train2, test2, labels, ntrain, 1, 2, 1200, donorm = True, verbose = verbose) #char ngrams   
