...
with open ('/home/E22301339/depressionDetection/codes-author/data/total_user_wordpost_Trainpart_5.json','r')as f:
...
with open('/home/E22301339/depressionDetection/codes-author/data/total_user_emotionpost_train5.json','w')as f:
