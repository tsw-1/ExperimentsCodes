...
def ngrams(train, test, labels, ntrain, mn=1, mx=1, nm=500, binary = False, donorm = False, stopwords = False, verbose = True, analyzer_char = False):
    ...
    # with open('/home/E22301339/depressionDetection/processedData/data3.json','w')as f:
    #     json.dump(data,f)
    print("........................end")
...
if __name__ == '__main__':
    ...
    X_train, y_train, X_test = ngrams(train, test, labels, ntrain, 1, 2, 400, donorm = True, verbose = verbose) #min_ngram, max_ngram, size of final vector
    X_train2, y_train, X_test2 = ngrams(train2, test2, labels, ntrain, 1, 2, 1600, donorm = True, verbose = verbose) #char ngrams   
