CUDA_VISIBLE_DEVICES=0 nohup python -u main_hier_clf.py --model_type /E22301339/bert-base-uncased --lr=2e-5 --input_dir /E22301339/HAN-BERT/eRisk2018/processed/combined_maxsim32_gpt --bs=4 --user_encoder=trans_symptom --num_trans_layers=4 > result_0913.txt 2>&1 &
