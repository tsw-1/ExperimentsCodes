...
if __name__ == '__main__':
    ...
    verbose = True
    t0 = time()
    X_train, y_train, X_test = ngrams(train, test, labels, ntrain, 1, 2, 1000, donorm = True, verbose = verbose) #min_ngram, max_ngram, size of final vector
    ...
    with open('/home/E22301339/depressionDetection/processedData/dataExper2.json','w')as f:
        json.dump(data,f)
