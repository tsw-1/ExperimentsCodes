...
with open ('/home/E22301339/depressionDetection/codes-author/data/total_user_wordpost_Testpart_1.json','r')as f:
...
with open('/home/E22301339/depressionDetection/codes-author/data/total_user_emotionpost_test1.json','w')as f:
