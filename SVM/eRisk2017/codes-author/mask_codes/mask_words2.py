...
with open ('/home/E22301339/depressionDetection/codes-author/data/total_user_wordpost_Trainpart_2.json','r')as f:
...
with open('/home/E22301339/depressionDetection/codes-author/data/total_user_emotionpost_train2.json','w')as f:
